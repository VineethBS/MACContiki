/**
 * \file
 *         Beacon ZMAC implementation
 *         Modification of TDMA code in Contiki 2.2 by Adam Dunkels
 *         Modification of TDMA Beacon code in Contiki 3.0
 * \author
...
#define BACKOFF_TIME RTIMER_SECOND/CLOCK_SECOND
#define BACKOFF_OFFSET RTIMER_SECOND/CLOCK_SECOND
...
/*---------------------------------------------------------------------------*/
const struct mac_driver beaconZMAC_driver = {
		"Beaconed ZMAC",
		init,
		send_packet,
		packet_input,
